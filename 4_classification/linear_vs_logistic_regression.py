...
qualifies_by_single_grade = pd.read_csv("data/linear_vs_logistic.csv")
...
linear_modeled_values = [int(round(v)) for v in linear_model.predict(X)]
...
plt.plot(X, linear_modeled_values, color="k")
plt.plot(X, linear_prediction_probability, color="k")
