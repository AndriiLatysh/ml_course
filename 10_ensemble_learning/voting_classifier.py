...
estimators.append(("SVC", SVC(kernel="rbf", gamma="scale", probability=True)))
estimators.append(("ANN", MLPClassifier(hidden_layer_sizes=(6, 4), max_iter=1000000)))
estimators.append(("DTC", DecisionTreeClassifier()))

ensemble = VotingClassifier(estimators, voting="soft")

results = model_selection.cross_val_score(ensemble, X, y, cv=k_folds)
