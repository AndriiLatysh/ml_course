...
ax2.scatter(x=object_sizes["width"], y=object_sizes["height"], c=kmeans_pp_classes, cmap="prism")

kmeans_pp_centroids = kmeans_pp_clustering_model.cluster_centers_
# print(kmeans_pp_centroids)

ax2.scatter(x=kmeans_pp_centroids[:, 0], y=kmeans_pp_centroids[:, 1], marker="X", color="k", s=100)
